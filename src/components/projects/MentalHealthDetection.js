...
// image paths
const projectImages = [
  `${process.env.PUBLIC_URL}/images/MentalHealth/model_architecture.png`,
  `${process.env.PUBLIC_URL}/images/MentalHealth/performance_metrics.png`,
  `${process.env.PUBLIC_URL}/images/MentalHealth/data_analysis.png`,
];
    ...
    <div className={`p-8 transition-colors duration-300 ${darkMode ? 'bg-[#121212]' : 'bg-gray-100'}`}>
      <header className="text-center mb-12">
        ...
        <p className={`text-xl transition-colors duration-300 ${darkMode ? 'text-[#B0BEC5]' : 'text-gray-600'}`}>
          Deep Learning Research Project | NLP Engineer & Model Architect
        </p>
      </header>
